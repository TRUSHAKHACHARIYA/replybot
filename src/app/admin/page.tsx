...
const shops = [
  { name: "Style Boutique", owner: "Priya Sharma", plan: "Standard", messages: 847, status: "active" },
  { name: "Glow Salon", owner: "Meera Joshi", plan: "Growth", messages: 1203, status: "active" },
  { name: "Fresh Bakes", owner: "Ankit Patel", plan: "Starter", messages: 234, status: "active" },
  { name: "FitZone Gym", owner: "Raj Kumar", plan: "Standard", messages: 567, status: "trial" },
  { name: "The Craft Studio", owner: "Neha Gupta", plan: "Starter", messages: 89, status: "trial" },
];
    ...
    <div className="space-y-8">
      ...
      <div className="bg-surface-card rounded-xl border border-border">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          ...
          <a href="/admin/shops" className="text-sm font-medium text-primary-500 hover:text-primary-600 transition-colors">
            View all &rarr;
          </a>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left py-3 px-6 font-medium text-text-secondary">Plan</th>
            ...
            <tbody>
              {shops.map((shop) => (
                <tr key={shop.name} className="border-b border-border last:border-0 hover:bg-surface transition-colors">
                  ...
                  <td className="py-4 px-6 text-text-secondary">{shop.owner}</td>
                  <td className="py-4 px-6">
                  ...
                  <td className="py-4 px-6 text-text-primary font-medium">{shop.messages.toLocaleString()}</td>
                  <td className="py-4 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-surface-card rounded-xl border border-border p-6">
          ...
          <span className="inline-flex items-center rounded-full bg-accent-50 px-2.5 py-0.5 text-xs font-medium text-accent-600">
            All Good
          </span>
        </div>
      </div>
